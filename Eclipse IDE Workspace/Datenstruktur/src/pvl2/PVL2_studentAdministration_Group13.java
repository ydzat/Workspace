...
\******************************************************************************/
	...
	public Boolean deregister(Integer matriculationNumber)
	{
		...
		if(matriculationNumber == null) found = null;
		else {
	...
	public String find(Integer matriculationNumber)
	{
		...
		// Confirming whether the matriculation number is "registered".
		if((matriculationNumber < students.get(low).getMatriculationNumber()) || (matriculationNumber > students.get(high).getMatriculationNumber()) || (low > high))
		{
			ret.append("null");
			wrong = true;
	...
	public Integer matriculate(String firstName, String lastName)
	{
		...
		if(firstName == null || lastName == null) ret = null;
		else 
		{
