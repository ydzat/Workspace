...
void App_HappyHolidays::program_step()
{
    ...
    // CGMatrix4x4 view = CGMatrix4x4::getTranslationMatrix(0.0f, 0.0f, -25.0f) * CGMatrix4x4::getRotationMatrixX(polar) * CGMatrix4x4::getRotationMatrixY(azimuth);
    ...
    drawColoredRect(0.8, 0.35, 0.9, 0.5);

    CGMatrix4x4 trans = CGMatrix4x4::getTranslationMatrix(0.0f, 0.0f, 1.0f);
    prog.uniform.modelViewMatrix = view * trans * scale;
    drawColoredRect(0.2, 0.8, 0.7, 0.5);
    context.blendingIsEnabled = false;
}
//------------------------------------------------------------------------------
void App_HappyHolidays::drawTree(const CGMatrix4x4 &view, const CGMatrix4x4 translation)
{
    ...
    CGMatrix4x4 rotationY = CGMatrix4x4::getRotationMatrixY(angle);

	// U08 A3a)

    modelViewTrunk = view * translation * rotationY;
    modelViewLeaf[0] = view * translation * CGMatrix4x4::getTranslationMatrix(0.0f, 2.5f, 0.0f) * rotationY * CGMatrix4x4::getRotationMatrixZ(-135);
    modelViewLeaf[1] = view * translation * CGMatrix4x4::getTranslationMatrix(0.0f, 3.0f, 0.0f) * rotationY * CGMatrix4x4::getRotationMatrixZ(-135) * CGMatrix4x4::getScaleMatrix(0.8f, 0.8f, 0.8f);
    modelViewLeaf[2] = view * translation * CGMatrix4x4::getTranslationMatrix(0.0f, 3.5f, 0.0f) * rotationY * CGMatrix4x4::getRotationMatrixZ(-135) * CGMatrix4x4::getScaleMatrix(0.5f, 0.5f, 0.5f );
