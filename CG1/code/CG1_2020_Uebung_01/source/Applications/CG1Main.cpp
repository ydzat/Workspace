...
#define FRAME_WIDTH  240   // Framebuffer width.
#define FRAME_HEIGHT 160   // Framebuffer height.
	 ...
	 char ** /*argv*/)
{
	...
	Application* app = (Application*) new App_FourPoints(FRAME_WIDTH,FRAME_HEIGHT);
