...
LastEditTime: 2022-02-10 19:41:29
...
g3.parse("C:\\Users\\ydzat\\OneDrive\\Workspace\\XML\\block4\\locations.rdf").serialize(format='turtle')
...
SELECT DISTINCT ?name ?the_book_name WHERE {
  ...
  ?author rdf:livesIn ?location
    FILTER (regex(?the_book_name, "about", "i") || regex(?location, "Magdeburg", "i"))
}
    """
)
