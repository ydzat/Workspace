'''
Author: your name
Date: 2021-12-07 08:15:59
LastEditTime: 2021-12-07 11:39:39
LastEditors: Please set LastEditors
Description: 
FilePath: \Workspace\XML\block2\liveTask1.py
'''
...
class personen():
    ...
    #     return personen.nameList
    # def getAssessmentList(self):
    #     return personen.assessmentList
    # def getName(self, idx):
    #     return personen.nameList[idx]
    # def getAssessment(self, idx):
    #     return personen.assessmentList[idx]
